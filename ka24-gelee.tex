...
\usepackage[a4paper, top=2cm, bottom=2cm, left=0cm, right=0cm]{geometry}
\usepackage{textcomp}
\pagestyle{empty}

\newcommand{\sometext}{
sol\textbullet{}ami\textbullet{}x klarapfelgelee\textbar gelée de pomme transparente blanche\\
klarapfel, gelierzucker, wasser, zitronensaft, zimt\textbar pomme transparente blanche, sucre gélifiant, eau, jus de citron, cannelle \\
...
\newcommand{\phw}{\dimexpr\labelw-3.2cm\relax}
